export const siteTexts = {
  ...
  problem: {
    ...
    solution: {
      ...
      text: "Jeśli czujesz, że to też o Tobie — cieszę się, że tu jesteś.",
      textStart: "Jeśli czujesz, że to o Tobie –",
      textMiddle: "To nie brak talentu.",
      emphasis: "Po prostu brakuje Ci kontaktu z żywym, praktycznym angielskim — takim, który naprawdę aktywizuje mózg i buduje pewność siebie. Szkoła, podręczniki czy aplikacje tego nie dają."
    }
  },

  benefits: {
    title: "Dzięki Aktywatorom:",
    items: [
      "Wyjdziesz z kołowrotka stresu, wstydu i lęku przed mówieniem.",
      "Zrozumiesz, dlaczego do tej pory Twoja nauka angielskiego nie działała – tylko Cię jeszcze bardziej blokowała.",
  ...
  author: {
    ...
    name: "Natalia Chas",
    description: [
      "Jestem certyfikowaną nauczycielką języka angielskiego jako obcego po studiach pedagogicznych, z dyplomem z nowoczesnej psychologii stosowanej. Posiadam również certyfikaty career coacha oraz life coacha. Wszystkie moje studia i kursy ukończyłam w Ameryce i Wielkiej Brytanii – gdzie studiowałam i pracowałam jednocześnie przez ponad 8 lat. Uczyłam wcześniej w brytyjskich szkołach – zarówno publicznych, jak i prywatnych – pracując zarówno z Anglikami, jak i obcokrajowcami. Obecnie jestem w trakcie kursu neurodydaktyki – nauki o tym, jak uczy się mózg.",
      "<br><strong>Pomagam Wam mówić własnym głosem </strong>– pewnie, swobodnie i bez barier – w mojej szkole mentoringowo-językowej SUN Mentoring School ze słonecznej Hiszpanii, w której mieszkam już drugi rok. Hiszpania jest moim szóstym krajem, w którym mieszkam i gdzie żyję na co dzień w trzech językach. Uwielbiam podróżować, uczyć się języków obcych i poznawać kultury innych krajów. Niedługo wybieram się na kilkumiesięczną solo podróż od Sri Lanki po Nepal, w trakcie której będę uczyć angielskiego lokalnych mieszkańców."
    ],
    imageAlt: "Natalia Chas - SUN Mentoring School",
    whatMakesSpecial: {
    ...
    credentials: [
      ...
      "Niedługo wybieram się na kilkumiesięczną solo podróż od Sri Lanki po Nepal"
    ],
    personalStory: {
      title: "Moja historia",
  ...
  personalStory: {
    ...
    content: [
      "Wiesz… **ja też wiem, jak to jest, gdy Twoje dłonie zaczynają się pocić ze stresu**, czujesz, że Twoja twarz staje się powoli coraz bardziej czerwona, a słowa jakby utkwiły Ci w gardle i nie możesz nic sensownego z siebie wykrztusić. Czarna dziura Cie pochłania. A to wszystko na proste słowa typu: \"Excuse me, can you tell me…?\" <br> Ja też tam byłam. Przez moje pierwsze miesiące mieszkania w Anglii byłam ciągle zestresowana, lękliwa i nie raz paliłam się ze wstydu. Nie rozumiałam większości tego, co mówili do mnie Anglicy, a nawet jeśli wydawało mi się, że coś tam wiem, to i tak nie byłam w stanie odpowiedzieć im nic sensownego. Czułam się beznadziejnie, a moja samoocena poszybowała wtedy mocno w dół.",
      "**A przecież uczyłam się angielskiego w szkole wiele lat** i zawsze miałam same piątki z testów. Poczułam się wtedy rozczarowana i sfrustrowana – tyle lat nauki zmarnowane. <br>Te 10 lat temu czułam, że każde moje słowo jest oceniane, że cokolwiek powiem – będzie błędne, i że nigdy nie nauczę się tego języka. To było moje zderzenie z rzeczywistością, a to był dopiero początek.",
      ...
      "**Teraz?** Czuję się często o wiele bardziej swobodnie w języku angielskim niż w polskim. Ukończyłam studia licencjackie na jednej z lepszych uczelni w UK i na świecie z pierwszą klasą z wyróżnieniem, przyznawaną najlepszym studentom na roku za ponadprzeciętne wyniki. Potem ukończyłam pedagogikę (5 stopnia), która pozwalała mi nauczać w szkołach wyższych. Po drodze ukończyłam jeszcze psychologię, coaching i wiele innych kursów. Prawda jest taka, że od tamtej pory codziennie się rozwijam i uczę czegoś nowego, bo po prostu uwielbiam to robić.<br>Gdy zaczęłam sama uczyć w szkołach, zrozumiałam, że posiadanie wiedzy to nie wszystko – ważniejsze jest to, jak ją przekazujemy (my, nauczyciele). Po ponad ośmiu latach przeprowadziłam się finalnie z Anglii do mojej słonecznej Hiszpanii, co było jednym z moich największych marzeń jeszcze z okresu dzieciństwa.<br>Od paru lat uczę angielskiego i wspieram wszystkie osoby, które – tak jak ja kiedyś – czują się dziś zestresowane, zlęknione czy rozczarowane. Wiem, jakie błędy JA popełniłam – i dzięki temu uczę się teraz innych języków efektywniej oraz pragnę dzielić się tym z innymi. Chciałabym, żebyście mogli spełniać siebie i swoje marzenia tak jak ja to teraz robię – dzięki angielskiemu, który kocham i który daje nam nieograniczone możliwości!"
    ]
  },
