export const siteTexts = {
  ...
  author: {
    title: "Poznajmy się!",
    name: "Natalia Chas",
    description: "Jestem certyfikowaną nauczycielką języka angielskiego jako obcego po studiach pedagogicznych, z dyplomem z nowoczesnej psychologii stosowanej. Posiadam również certyfikaty career coacha oraz life coacha. Wszystkie moje studia i kursy ukończyłam w Ameryce i Wielkiej Brytanii – gdzie studiowałam i pracowałam jednocześnie przez ponad 8 lat.",
